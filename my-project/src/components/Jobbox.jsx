  ...
  return (
    <>
      <div className='p-5 mt-5'>
        {
          jobs?.data?.map(i => <div className=' border mt-5 border2 border-black p-5'>
            ...
            <Link to={`/job/${title}${place}`} type="button" className="text-white mt-5 bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">View Details</Link>
          </div>)
        }
      </div>
